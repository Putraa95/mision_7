      ...
      <section className="p-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="order-3 lg:order-2 col-span-2">
            ...
            <Pagination
              currentPage={1} // Sesuaikan dengan state atau props yang sesuai
              totalPages={6} // Sesuaikan dengan total halaman
              onPageChange={(page) => console.log(page)} // Ganti dengan fungsi penanganan perubahan halaman
            />
          </div>
        </div>
      </section>
